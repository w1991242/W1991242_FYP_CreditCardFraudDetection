...
This project is the final prototype for a credit card fraud detection system using machine learning.  
...
- Loads a pre-trained **XGBoost** model and a fitted **scaler**
